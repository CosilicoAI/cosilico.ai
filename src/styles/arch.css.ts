...
/**
 * Cosilico Arch Page Styles
 *
 * Design direction: Foundational archive aesthetic with cyan accent.
 * Focus on data provenance and source tracking.
 */
...
globalStyle(`${arch} h1, ${arch} h2, ${arch} h3, ${arch} h4`, {
...
export const sourceCardGlow = style({
  position: 'absolute',
  top: 0,
  left: 0,
  right: 0,
...
export const sourceMetaIcon = style({
  width: '14px',
  height: '14px',
  color: vars.color.accent,
});
...
export const sourceComingSoon = style({
...
export const installSubtext = style({
  fontSize: '1.1rem',
  color: vars.color.textSecondary,
  marginBottom: vars.space.xl,
  position: 'relative',
...
export const installLinkSecondary = style({
